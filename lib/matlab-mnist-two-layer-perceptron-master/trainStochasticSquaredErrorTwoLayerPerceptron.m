...
% 
    ...
    hiddenWeights = rand(numberOfHiddenUnits, inputDimensions);%zeros(numberOfHiddenUnits,inputDimensions);
    outputWeights = rand(outputDimensions, numberOfHiddenUnits); %zeros(outputDimensions, numberOfHiddenUnits);
